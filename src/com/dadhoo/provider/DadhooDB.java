...
public class DadhooDB {
	...
	public static final String AUTHORITY = "com.dadhoo.com.Dadhoo";

	public static final String ALBUM_AUTHORITY = "com.dadhoo.com.DadhooAlbums";
	...
	public static final class Albums implements BaseColumns {
		...
		public static final Uri VIDEOS_URI = Uri.parse("content://"
				+ ALBUM_AUTHORITY + "/" + Albums.VIDEO_NAME);
